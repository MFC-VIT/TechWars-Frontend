  ...
  return (
    <div className="h-screen overflow-hidden">
      <img
        src={logoPhoto}
        alt=""
        className="absolute z-10 h-[19%] top-[5%] left-[8%] lg:left-[9%] xl:h-[20%] xl:left-[10%] xl:top-[8%]"
      />
      <div className="contain flex justify-center items-center h-screen">
        ...
        <form
          ...
          className="relative w-[60%] h-[30%] flex flex-col sm:w-[39%] md:h-[31%] md:w-[35%] justify-around items-center lg:w-[30%] lg:h-[37%] xl:w-[23%]"
        >
          <input
            type="text"
